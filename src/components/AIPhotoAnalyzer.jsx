    ...
    >
      ...
      <div
        style={{
          ...
          )}, ${getScoreColor(analysis.overall.score)}dd)`,
          color: "white",
          borderRadius: "15px",
          padding: "25px",
          textAlign: "center",
      ...
      <div style={{ marginBottom: "25px" }}>
        ...
        >
          ...
          >
            ...
            <div style={{ color: "#666", fontSize: "12px" }}>
              {analysis.technical.colorBalance.status === "balanced"
                ? "Сбалансировано"
                : "Дисбаланс"}
            </div>
          </div>
          ...
          >
            ...
            <div style={{ fontSize: "13px", color: "#666", lineHeight: "1.8" }}>
              <div>
                ...
                {analysis.technical.resolution.width}×
                {analysis.technical.resolution.height} (
                {analysis.technical.resolution.megapixels} МП)
              </div>
              <div>
                <strong>HD качество:</strong>{" "}
                {analysis.technical.resolution.isHD ? "✅ Да" : "❌ Нет"}
              </div>
              <div>
                <strong>RGB баланс:</strong> R:
                {analysis.technical.colorBalance.rgb.r} G:
                {analysis.technical.colorBalance.rgb.g} B:
                {analysis.technical.colorBalance.rgb.b}
              </div>
              {analysis.composition.centering && (
                <div>
                  <strong>Центрирование:</strong>{" "}
                  {analysis.composition.centering.score}% (
                  {analysis.composition.centering.message})
                </div>
              )}
            </div>
          </div>
      ...
      <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
        <button
          onClick={() => {
            const reportText = `Анализ фото "${
              dishInfo.name || "блюда"
            }":\n\nОбщий балл: ${
              analysis.overall.score
            }/100\n\nРекомендации:\n${analysis.recommendations
              .map((r) => `• ${r.message}: ${r.action}`)
              .join("\n")}`;
      ...
      >
        ...
        >
          💡 <strong>Совет:</strong> Для лучших результатов фотографируйте блюдо
          при естественном освещении, размещайте его в центре кадра и убедитесь,
          что фото четкое!
        </p>
      </div>
    </div>
