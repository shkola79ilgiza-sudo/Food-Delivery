  ...
  const demoDishes = useMemo(
    () => [
      ...
      },
      {
        name: "цезарь",
        category: "салаты",
        ingredients: "курица, салат, помидоры, сыр пармезан, сухарики, соус",
      },
      {
        name: "плов",
      ...
      },
      {
        ...
        category: "паста",
        ingredients: "макароны, бекон, яйца, сыр пармезан, сливки",
      },
    ],
    []
  );
      ...
      {demoData && !loading && (
        <div>
          ...
          >
            <h3 style={{ margin: "0 0 15px 0", color: "#2c3e50" }}>
              📊 Анализ:{" "}
              {demoData.dish.name.charAt(0).toUpperCase() +
                demoData.dish.name.slice(1)}
            </h3>
              ...
              >
                ...
                <div
                  style={{
                    ...
                    fontWeight: "bold",
                    color:
                      demoData.analysis.overallScore >= 70
                        ? "#28a745"
                        : demoData.analysis.overallScore >= 50
                        ? "#ffc107"
                        : "#dc3545",
                  }}
                >
          ...
          {demoData.priceData.storePrices.data.length > 0 && (
            ...
            >
              ...
              >
                ...
                Диапазон: {demoData.priceData.storePrices.min}₽ -{" "}
                {demoData.priceData.storePrices.max}₽
              </div>
            </div>
          )}
          ...
          {demoData.priceData.restaurantPrices.data.length > 0 && (
            ...
            >
              ...
              >
                {demoData.priceData.restaurantPrices.data.map(
                  (restaurant, index) => (
                    <div
                      key={index}
                      style={{
              ...
              >
                ...
                Диапазон: {demoData.priceData.restaurantPrices.min}₽ -{" "}
                {demoData.priceData.restaurantPrices.max}₽
              </div>
            </div>
          )}
