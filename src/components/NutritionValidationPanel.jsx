...
const NutritionValidationPanel = ({
  manualData,
  ingredients,
  ...
  const validateNutrition = useCallback(async () => {
    setIsValidating(true);
    try {
      const result = await aiNutritionValidator.validateNutrition(
        manualData,
        ingredients
      );
  ...
  }, [manualData, ingredients, onAutoFill, onValidationComplete]);
  ...
  }, [manualData, ingredients, validateNutrition]);
  ...
  const formatted =
    aiNutritionValidator.formatValidationResult(validationResult);
  ...
  return (
    ...
    >
      ...
      {validationResult.aiInsights &&
        validationResult.aiInsights.length > 0 && (
          <div
            style={{
              background: "rgba(255,255,255,0.15)",
              borderRadius: "8px",
