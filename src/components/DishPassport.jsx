    ...
    try {
      ...
      if (!foundDish) {
        const chefDishes = JSON.parse(
          localStorage.getItem(`chef_${chefId}_dishes`) || "[]"
        );
      ...
      const reviews = JSON.parse(
        localStorage.getItem(`dish_reviews_${dishId}`) || "[]"
      );
      setReviews(reviews);
    ...
    <div className="dish-passport">
      <div className="passport-header">
        ...
        <div className="qr-code-section">
          ...
          <p className="qr-note">
            Отсканируйте QR-код для получения информации о блюде
          </p>
        </div>
      </div>
          ...
          <div className="dish-details">
            ...
            <div className="dish-meta">
              ...
              <span className="category">
                {getCategoryName(dish.category_id || dish.category)}
              </span>
          ...
          <div className="chef-details">
              ...
              {chef?.avatar ? (
                ...
                <div className="avatar-placeholder">
                  {chef?.name
                    ...
                    : chef?.email
                    ? chef.email.charAt(0).toUpperCase()
                    : "П"}
                </div>
              )}
            </div>
            <div className="chef-info">
              ...
              <p className="chef-specialization">
                Специализация:{" "}
                {getSpecializationName(chef?.specialization) || "Не указано"}
              </p>
              <p className="chef-experience">
                Опыт: {chef?.experience || "0"} лет
              </p>
              <div className="chef-rating">
                <span className="rating-label">Рейтинг:</span>
                <span className="rating-value">
                  {chefRating > 0
                    ? `⭐ ${chefRating.toFixed(1)}/5`
                    : "Пока нет оценок"}
                </span>
                {chefReviewsCount > 0 && (
                  <span className="reviews-count">
                    ({chefReviewsCount} отзывов)
                  </span>
                )}
              </div>
            </div>
          ...
          <div className="info-grid">
            <div className="info-item">
              ...
              <span className="info-value">
                {dish.createdAt ? formatDate(dish.createdAt) : "Не указано"}
              </span>
            </div>
            <div className="info-item">
            ...
            <div className="photos-grid">
              {dish.before_photo && (
                <div className="photo-item">
                  ...
                  <img
                    src={dish.before_photo}
                    alt="До приготовления"
              ...
              {dish.after_photo && (
                <div className="photo-item">
                  ...
                  <img
                    src={dish.after_photo}
                    alt="После приготовления"
                    className="process-photo"
                  />
                </div>
              )}
