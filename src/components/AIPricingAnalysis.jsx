...
const AIPricingAnalysis = ({ dishData, onAnalysisComplete }) => {
  ...
  const runAnalysis = useCallback(async () => {
    ...
    try {
      const result = await aiPricingAssistant.analyzePricing(
        dishData,
        userLocation
      );
      setAnalysis(result);
      ...
      setError(
        `Ошибка при анализе ценообразования: ${
  ...
  }, [dishData, userLocation, onAnalysisComplete]);
  ...
  }, [dishData, userLocation, runAnalysis]);
    ...
    >
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: "12px", opacity: 0.8 }}>
            {analysis.demandForecast.season} •{" "}
            {analysis.demandForecast.timeOfDay}
          </div>
        </div>
      </div>
        ...
        >
          ...
          {analysis.competitorAnalysis.restaurants && (
            ...
            >
              ...
              <div style={{ fontSize: "12px", opacity: 0.8 }}>
                Диапазон: {analysis.competitorAnalysis.restaurants.min}-
                {analysis.competitorAnalysis.restaurants.max}₽
              </div>
            </div>
          )}
          ...
          {analysis.competitorAnalysis.homeChefs && (
            ...
            >
              ...
              <div style={{ fontSize: "12px", opacity: 0.8 }}>
                Диапазон: {analysis.competitorAnalysis.homeChefs.min}-
                {analysis.competitorAnalysis.homeChefs.max}₽
              </div>
            </div>
          )}
        </div>
          ...
          <div style={{ display: "grid", gap: "10px" }}>
            {analysis.recommendations.map((rec, index) => (
              ...
              >
                ...
                <div style={{ fontSize: "14px" }}>{rec.message}</div>
                {rec.price && (
                  <div
                    style={{
                      marginTop: "8px",
        ...
        >
          <div>
            ...
            <div style={{ fontSize: "14px", marginBottom: "3px" }}>
              Распознано:{" "}
              {analysis.ingredientAnalysis.recognizedIngredients.length} шт.
            </div>
            <div style={{ fontSize: "14px", marginBottom: "3px" }}>
              Время приготовления: {analysis.ingredientAnalysis.preparationTime}{" "}
              мин.
            </div>
            <div style={{ fontSize: "14px" }}>
