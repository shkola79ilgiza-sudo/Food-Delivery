...
const AIBenefitPanel = ({ dish, onBenefitGenerated }) => {
  ...
  const formats = [
    ...
    },
    {
      id: "medium",
      name: "Средний",
      description: "Сбалансированное описание",
      icon: "📄",
    },
    {
      id: "long",
  ...
  const generateBenefits = useCallback(() => {
    if (!dish) return;
    ...
    try {
      ...
      const allBenefits = {
        ...
        medium: aiBenefitGenerator.generateBenefit(
          dish,
          "medium",
          selectedGoal
        ),
      ...
      const generatedHeadlines =
        aiBenefitGenerator.generateCatchyHeadlines(dish);
      const generatedHashtags = aiBenefitGenerator.generateHashtags(
        dish,
        selectedGoal
      );
  ...
  }, [dish, selectedFormat, selectedGoal, generateBenefits]);
    ...
    return (
      ...
      >
        ...
        <h4 style={{ margin: "0", color: "#333" }}>
          AI генерирует продающие тексты...
        </h4>
  ...
  return (
    ...
    >
          ...
          {formats.map((format) => (
            <button
              ...
              style={{
                ...
                border: `2px solid ${
                  selectedFormat === format.id ? "#4caf50" : "#e0e0e0"
                }`,
                padding: "10px 15px",
                borderRadius: "8px",
                cursor: "pointer",
          ...
          {goals.map((goal) => (
            <button
              ...
              style={{
                ...
                border: `2px solid ${
                  selectedGoal === goal.id ? "#2196f3" : "#e0e0e0"
                }`,
                padding: "8px 12px",
                borderRadius: "8px",
                cursor: "pointer",
      ...
      >
        ...
        >
          💡 <strong>Совет:</strong> Используйте эти тексты в описании блюда,
          социальных сетях или рекламных материалах. Они автоматически
          подстраиваются под цель клиента!
        </p>
      </div>
    </div>
  );
