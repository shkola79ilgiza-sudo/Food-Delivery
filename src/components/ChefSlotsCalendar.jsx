        ...
        <div style={{ display: "flex", alignItems: "center", gap: "15px" }}>
          <button
            onClick={() => {
              ...
              console.log(
                "🔍 ChefSlotsCalendar - onClose available:",
                !!onClose
              );
        ...
        >
          ...
          <div style={{ fontSize: "13px", lineHeight: "1.6", color: "#333" }}>
            <div style={{ marginBottom: "15px" }}>
              <strong style={{ color: "#1976d2" }}>🎯 Основная функция:</strong>
              <br />
              Планируйте когда вы будете доступны для приема заказов от
              клиентов.
            </div>
            ...
            <div style={{ marginBottom: "15px" }}>
              ...
              <ul style={{ margin: "8px 0", paddingLeft: "20px" }}>
                <li>
                  <strong>Клик по ячейке</strong> - включает/выключает слот для
                  конкретного времени и дня
                </li>
                <li>
                  <strong>Навигация</strong> - используйте кнопки "Предыдущая
                  неделя" и "Следующая неделя"
                </li>
                <li>
                  <strong>Копирование</strong> - нажмите "Копировать на неделю"
                  чтобы скопировать слоты выбранного дня
                </li>
                <li>
                  <strong>Очистка</strong> - кнопка "Очистить день" удаляет все
            ...
            <div style={{ marginBottom: "15px" }}>
              ...
              <ul style={{ margin: "8px 0", paddingLeft: "20px" }}>
                ...
                <li>
                  ...
                  - Заполнен (достигнут лимит заказов)
                </li>
                <li>
            ...
            <div style={{ marginBottom: "15px" }}>
              ...
              <ul style={{ margin: "8px 0", paddingLeft: "20px" }}>
                <li>
                  <strong>Максимум заказов</strong> - лимит заказов в час (по
                  умолчанию: 10)
                </li>
                <li>
                  <strong>Множитель цены</strong> - возможность увеличить цену в
                  пиковые часы
                </li>
                <li>
                  <strong>Текущие заказы</strong> - счетчик принятых заказов
                  (формат: текущие/максимум)
                </li>
              </ul>
            </div>
            ...
            >
              <strong>💾 Автосохранение:</strong> Все изменения сохраняются
                    ...
                    <>
                      ...
                      <div style={{ fontSize: "8px", opacity: 0.8 }}>
                        {slot.priceMultiplier > 1
                          ? `+${Math.round((slot.priceMultiplier - 1) * 100)}%`
                          : ""}
                      </div>
                    </>
                  )}
        ...
        >
          ...
          <div>
            ...
            {Object.values(slots).reduce(
              (total, daySlots) =>
                total +
                Object.values(daySlots).filter((slot) => slot.isActive).length,
              0
            )}
          </div>
          <div>
