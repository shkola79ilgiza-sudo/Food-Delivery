...
const ChefSelection = ({ onChefSelect, onClose }) => {
  ...
  const loadChefs = useCallback(() => {
    try {
      ...
      const savedChefs = JSON.parse(
        localStorage.getItem("registeredChefs") || "[]"
      );
        ...
        const demoChefs = [
          {
            ...
            avatar: "👩‍🍳",
            description:
              "Специализируюсь на традиционной русской кухне и домашней выпечке",
            priceRange: "$$",
          ...
          },
          {
            ...
            avatar: "👨‍🍳",
            description:
              "Мастер узбекской кухни, готовлю аутентичный плов и шашлык",
            priceRange: "$$$",
          ...
          },
          {
            ...
            avatar: "👩‍🍳",
            description:
              "Итальянская кухня с любовью, свежие ингредиенты и традиционные рецепты",
            priceRange: "$$",
  ...
  return (
    <div className="chef-selection-overlay" onClick={onClose}>
      <div
        className="chef-selection-modal"
                  ...
                  <div className="chef-card-body">
                    ...
                    <div className="chef-details">
                      <div className="detail-row">
                        <span>
                          ⭐ Рейтинг: {chef.rating} ({chef.reviews} отзывов)
                        </span>
