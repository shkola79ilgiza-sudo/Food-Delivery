export const en = {
  ...
  features: {
    ...
    chefSupportDesc: 'We actively promote the chefs of our service and their dishes. We help them become popular and earn more.',
    process: 'PROCESS',
    processDesc: 'We take care of issues with customers, payments, and everything else, so your income grows.',
    keyFeatures: 'Key features of the service',
    authenticReviews: 'ONLY AUTHENTIC reviews',
    authenticReviewsDesc: 'The buyer leaves a review only after receiving the order.',
    ...
    incomeScheduleDesc: 'Cook when it\'s convenient, attract clients through the service.'
  },
  ...
  checkout: {
    ...
    moneyReserved: 'Money will be reserved and transferred to the chef after delivery confirmation'
  },
  ...
  chefMenu: {
    ...
    ingredientsPlaceholder: 'For example: beef 300g, potatoes 200g, onion 1pc, carrots 100g',
    autoCalculationHint: '💡 System will automatically calculate calories and macros based on specified ingredients',
    autoCalculationNote: '🤖 Automatically calculated based on ingredients (can be changed manually)',
    ingredientsFormat: '📝 Format: product name + quantity + unit of measurement (g, kg, ml, l, pcs, tsp, tbsp)',
    calories: 'Calories (kcal)',
    protein: 'Protein (g)',
    carbs: 'Carbs (g)',
    fat: 'Fat (g)',
    isClientProducts: 'Dish from client products (before/after photos required)',
    ...
    profileDescription: 'Tell us about yourself, your culinary preferences and achievements...',
    ...
    kitchenAddressPlaceholder: 'Enter full kitchen address: city, street, house, apartment...',
    kitchenAddressHelp: 'Without address it is impossible to calculate delivery zone (3-5 km). Address is shown to clients for pickup and to couriers for delivery.'
  },
  ...
  cartEmptyDesc: 'Add items from the menu',
  goToMenu: 'Go to Menu',
  itemsInCart: 'Items in Cart',
  orderSummary: 'Order Summary',
  promoCode: 'Promo Code',
  ...
  chefWillReceive: 'Chef will receive:',
  totalToPay: 'Total to Pay:',
  paymentStatusInfo: '💳 Money will be reserved and transferred to the chef after delivery confirmation',
  ...
  aiCoach: {
    ...
    friedAdvice: 'Try baked or steamed dishes. I recommend salads and grilled vegetables.',
    addVegetables: 'Add more vegetables',
    vegetablesAdvice: 'Vegetables are rich in vitamins and fiber. Try fresh salads, stewed vegetables or vegetable soups.',
  ...
  aiChefAssistant: {
    ...
    ingredientsPlaceholder: 'For example: chicken breast, iceberg lettuce, tomatoes, parmesan cheese, croutons, caesar sauce',
  ...
  chefPlanningAssistant: {
    ...
    oftenOrdered: 'These dishes are ordered most often - make sure they are always in stock',
    category: 'Category',
    ...
    lowRevenue: 'These dishes are ordered but bring little revenue. Consider optimization',
